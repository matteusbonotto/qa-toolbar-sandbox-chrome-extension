...
function renderReportBuilder(container, context, prefill) {
  ...
  const buildReportText = () => {
    ...
    const lines = [
      ...
      prefill.evidenceCount ? `\n${t.reportEvidenceLabel}: ${prefill.evidenceCount}. ${t.reportEvidenceHint}` : "",
      prefill.mediaMode ? `\n${t.reportMediaLabel}: ${prefill.mediaMode === "gif" ? t.reportMediaGif : t.reportMediaVideo}. ${t.reportMediaHint}` : "",
    ];
...
Object.assign(QA_SURFACE_TRANSLATIONS.es, {
  ...
  "Selecionar input na página": "Seleccionar campo en la página", "Regras encontradas": "Reglas encontradas", "Regras": "Reglas", "Resultado atual": "Resultado actual", "Ainda não validado nesta seleção.": "Todavía no se validó esta selección.",
  ...
  "Diagnóstico concluído sem regras declaradas": "Diagnóstico concluido sin reglas declaradas", "Sem regras declaradas": "Sin reglas declaradas",
...
Object.assign(QA_SURFACE_TRANSLATIONS.en, {
  ...
  "Selecionar input na página": "Select field on page", "Regras encontradas": "Rules found", "Regras": "Rules", "Resultado atual": "Current result", "Ainda não validado nesta seleção.": "Not validated yet for this selection.",
  ...
  "Diagnóstico concluído sem regras declaradas": "Diagnostics completed without declared rules", "Sem regras declaradas": "No rules declared",
