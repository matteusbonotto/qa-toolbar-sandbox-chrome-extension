...
export const FEATURE_REGISTRY = Object.freeze([
  ...
  ["clickSpy","Clique espião","clickSpyMenuItem","mouse",""],
  ["freezeClock","Parar tempo","freezeClockMenuItem","freezeClock",""],
  ...
  ["inputLab","Validador de campos","inputLabMenuItem","inputLab","inputLab.enabled"],
  ["fakerFill","Auto preenchimento","fakerFillMenuItem","fakerFill","fakerFill.enabled"],
