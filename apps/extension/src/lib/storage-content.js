...
(() => {
  ...
  const FEATURE_REGISTRY = Object.freeze([
    ...
    ["clickSpy","Cliques","clickSpyMenuItem","mouse",""],["freezeClock","Data e hora","freezeClockMenuItem","freezeClock",""],
    ["forceHttp","Respostas HTTP","forceHttpMenuItem","forceHttp",""],["errorMonitor","Erros HTTP","errorMonitorMenuItem","errorMonitor",""],
    ["inspectors","Observador de endpoints","inspectorsMenuItem","inspectors",""],["jsonStudio","JSON Studio","jsonStudioMenuItem","braces",""],
    ["breakpoints","Tamanhos de tela","breakpointMenuItem","breakpointViewer",""],["testAccounts","Contas de teste","testAccountsMenuItem","key",""],
    ...
    ["multiClick","Multiclick","multiClickMenuItem","multiClick","multiClick.enabled"],["inputLab","Laboratório de campos","inputLabMenuItem","inputLab","inputLab.enabled"],
    ["fakerFill","Dados fictícios","fakerFillMenuItem","fakerFill","fakerFill.enabled"],["keyView","Teclas e mouse","keyViewMenuItem","keyView","keyView.enabled"],
    ["elementCapture","Elementos da página","elementCaptureMenuItem","elementCapture","elementCapture.enabled"],
    ["blurElements","Privacidade visual","blurElementsMenuItem","eyeSlash",""],["holofote","Holofote","holofoteMenuItem","lightbulb",""],
