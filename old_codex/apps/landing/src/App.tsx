    ...
    <div className="site-shell" ref={localizedRootRef}>
      ...
      <main>
        ...
        <section className="section container install-section" id="instalar">
          ...
          <div className="momentum-callout" data-reveal><span className="momentum-icon"><FiZap /></span><div><span className="kicker">Testes manuais com sabor automático</span><h3>Você mantém o olhar crítico. A toolbar tira o trabalho repetitivo do caminho.</h3><p>Menos tempo montando contexto, procurando conta sandbox e organizando evidência. Mais qualidade de vida, velocidade e foco para testar o que realmente importa.</p></div></div>
