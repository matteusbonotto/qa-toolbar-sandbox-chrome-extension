...
const ptBR: Catalog = {
  ...
  "landing.heroTitle": "Teste páginas reais com sua barra de ferramentas de QA no navegador.", "landing.heroAction": "Verificar acesso e instalar", "landing.plansTitle": "Comece livre. Evolua quando fizer sentido.", "landing.monthly": "Mensal", "landing.yearly": "Anual", "landing.faq": "Perguntas frequentes", "landing.about": "Sobre",
...
const en: Catalog = {
  ...
  "landing.heroTitle": "Test real pages with your QA toolbar in the browser.", "landing.heroAction": "Verify access and install", "landing.plansTitle": "Start free. Upgrade when it makes sense.", "landing.monthly": "Monthly", "landing.yearly": "Yearly", "landing.faq": "Frequently asked questions", "landing.about": "About",
...
const es: Catalog = {
  ...
  "landing.heroTitle": "Prueba páginas reales con tu barra de herramientas de QA en el navegador.", "landing.heroAction": "Verificar acceso e instalar", "landing.plansTitle": "Empieza gratis. Evoluciona cuando tenga sentido.", "landing.monthly": "Mensual", "landing.yearly": "Anual", "landing.faq": "Preguntas frecuentes", "landing.about": "Acerca de",
