...
assert.match(toolbar, /A conta ativa agora mostra o plano na Landing Page/);
assert.match(options, /A conta ativa agora mostra o plano na Landing Page/);
assert.match(toolbar, /The Install button shows the package version/);
assert.match(options, /Cuando Chrome Web Store está pendiente, hay una descarga directa/);
