...
const functions = ["checkout-create-session", "stripe-webhook", "voucher-redeem", "referral-track", "keep-alive", "access-status", "auth-sign-in", "auth-refresh", "admin-email-otp"];
let assertions = 0;
