...
const functions = ["checkout-create-session", "stripe-webhook", "voucher-redeem", "voucher-preview", "legal-registration", "referral-track", "rewards-spin", "keep-alive", "access-status", "auth-sign-in", "auth-refresh", "auth-recover-password", "admin-email-otp"];
let assertions = 0;
